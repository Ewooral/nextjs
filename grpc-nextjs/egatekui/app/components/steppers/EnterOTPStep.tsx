...
const EnterOTP: React.FC<verifyOTPType> = ({
  register,
  errors,
  isRendered,
  otp,
  ...
  const { setOTPCode } = useStepperStore(state => ({ otp: state.personalInfo.otp, setOTPCode: state.setOTPCode }));
      ...
      >
        <div className="flex flex-col px-5 my-auto max-md:max-w-full max-md:mt-10">
          ...
          >
            ...
            /> */}
            <PinIcon className="text-[gray] text-[18px] items-center justify-center object-contain object-center w-6 max-w-full overflow-hidden aspect-square shrink-0" />
            <input
              type="text"
